...
// detect the paths of the core ScalaLab jars at the local file system
      ...
      set.classpath.add(scalalab.JavaGlobals.jarFilePath)    
      set.classpath.add(scalalab.JavaGlobals.compFile)  // Scala Compiler
      set.classpath.add(scalalab.JavaGlobals.libFile)     // Scala Libraries
      if (scalalab.JavaGlobals.reflectFile != null)
        set.classpath.add(scalalab.JavaGlobals.reflectFile)  // scala-reflect file
      set.classpath.add(scalalab.JavaGlobals.swingFile)  // Scala Swing

         set.classpath.add(scalalab.JavaGlobals.ejmlFile)   // EJML file
      set.classpath.add(scalalab.JavaGlobals.rsyntaxTextAreaFile)
      set.classpath.add(scalalab.JavaGlobals.jblasFile)   // JBLAS file
      set.classpath.add(scalalab.JavaGlobals.jsciFile)   // JSci library
      set.classpath.add(scalalab.JavaGlobals.javacppFile)
      set.classpath.add(scalalab.JavaGlobals.JASFile)    // Java Algebra System
      set.classpath.add(scalalab.JavaGlobals.LAPACKFile)    // LAPACK library file
      set.classpath.add(scalalab.JavaGlobals.ARPACKFile)    // ARPACK library file
      
        
      set
   }
     scalaExec.Interpreter.GlobalValues.globalInterpreter = new IMain()
  }
...
// detect the paths of the core ScalaLab jars at the local file system
    ...
    prepareSettings(set)        
      ...
      if (scalalab.JavaGlobals.reflectFile != null)
        set.classpath.add(scalalab.JavaGlobals.reflectFile)  // scala-reflect file
      set.classpath.add(scalalab.JavaGlobals.swingFile)  // Scala Swing
      set.classpath.add(scalalab.JavaGlobals.ApacheCommonsFile)   // Apache Common Maths current version file
      set.classpath.add(scalalab.JavaGlobals.ejmlFile)   // EJML file
      set.classpath.add(scalalab.JavaGlobals.rsyntaxTextAreaFile)
      set.classpath.add(scalalab.JavaGlobals.jblasFile)  // JBLAS File
      set.classpath.add(scalalab.JavaGlobals.jsciFile)   // JSci library
