...
public class GlobalValues {
    ...
    static public String scalalabBuildVersiοn = " 14 - Nov - 2022 ";
    ...
    static public String buildTitle() {
        ...
        String mainFrameTitle =        "ScalaLab:    Scala 3 ,  library type: "+ GlobalValues.interpreterType()+
                ",   "+System.getProperty("java.vm.name", "").toLowerCase()+",  "+ System.getProperty("os.name", "").toLowerCase()+
                "  "+ System.getProperty("os.arch", "").toLowerCase()+" ,   "+
                GlobalValues.scalalabBuildVersiοn;
...
//            "import _root_.scalaSci.StaticScalaSciGlobalExt ; \n "+
    ...
    static public    String  basicImportsEJMLScala = commonImports+
    ...
    static public    String  basicImportsJBLASScala = commonImports+
